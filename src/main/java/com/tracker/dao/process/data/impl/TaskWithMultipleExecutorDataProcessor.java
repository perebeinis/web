...
public class TaskWithMultipleExecutorDataProcessor implements DataProcessor {
    ...
    public String processData(Object incomingDataObject, String elementType, String elementId) {
        if (StringUtils.isEmpty(elementId)) {
            return createData(incomingDataObject, BaseConstants.ISSUE, elementId);
        } else {
            return updateData(incomingDataObject, BaseConstants.ISSUE, elementId);
        }
    }
