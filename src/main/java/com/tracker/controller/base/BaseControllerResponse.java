...
public class BaseControllerResponse {
    ...
    public ModelMap getBaseResponseData(ModelMap model, Authentication authentication, Locale locale){
        model.addAttribute(BaseConstants.HEADER_LIST, CardDataProcessor.getInstance().getMenuItemsForUser(BaseConstants.HEADER_ELEMENT_CONSTANT));
        model.addAttribute(BaseConstants.MENU_LIST, CardDataProcessor.getInstance().getMenuItemsForUser(BaseConstants.MENU_ELEMENT_CONSTANT));
    ...
    public Map<String, Object> getBaseResponseDataJson(ModelMap model, Authentication authentication, Locale locale){
        ...
        resultMap.put(BaseConstants.HEADER_LIST, CardDataProcessor.getInstance().getMenuItemsForUser(BaseConstants.HEADER_ELEMENT_CONSTANT));
        resultMap.put(BaseConstants.MENU_LIST, CardDataProcessor.getInstance().getMenuItemsForUser(BaseConstants.MENU_ELEMENT_CONSTANT));
    ...
    public BaseControllerResponse(UserDetailsService customUserDetailsService) {
